...
const Cart = (props) => {
    const {unDisplayCartFn} = props;
    let totalPrice = props.products.reduce((total, item) => total + item.price * item.quantity, 0);
    return ( 
        <>
            <section className="miniCart">
              <div className="miniCart-container">
                <div className="miniCart-header">
                  ...
                  <button onClick={unDisplayCartFn} className="miniCart-closeBtn">
                ...
                <div className="miniCart-tagline">
                  <i className="fa-solid fa-truck-arrow-right tagline-icon"></i>MIỄN PHÍ VẬN
                  CHUYỂN ĐƠN HÀNG {">"} 
                </div>
                ...
                <div className="miniCart-footer">
                  <div className="miniCart-total">
                    ...
                    <span className="miniCart-price" data-value="1">{totalPrice} ₫</span>
                  </div>
                  <button onClick={unDisplayCartFn} >
                  <Link className="navbar-brand " to="/pay"><i class="fa-solid fa-user"></i> 

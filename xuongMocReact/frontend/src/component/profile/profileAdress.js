    ...
    <div className="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10 profile_right">
      ...
      {isform && (
        <form className="form_adress">
          ...
          <div onClick={editAdress} className="form-group row">
      ...
      <div className="item_adress">
        <div className="item_adress_top row">
          <div className="col-sm-2">
            <p className="name_adress">Trần Văn Tú</p>
          </div>
          <div className="col-sm-1 ">
            <p className="text_adress">0987123453</p>
          </div>
          <div className="col-sm-10"></div>
        </div>
        <div className="item_adress_bit">
          <p className="text_adress">
            {" "}
            số 3,đường Cầu Giấy,Quận Cầu Giấy,Hà Nội
          </p>
        </div>
